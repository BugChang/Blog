...
namespace Blog.Blazor.Utils
{
    ...
    public class JSModule : IAsyncDisposable
    {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public virtual async ValueTask InvokeVoidAsync(string identifier, CancellationToken cancellationToken = default,
            params object?[]? args)
        {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public virtual ValueTask<TValue> InvokeAsync<TValue>(string identifier, TimeSpan timeout,
            params object?[]? args)
        {
            using CancellationTokenSource? cancellationTokenSource =
                ((timeout == Timeout.InfiniteTimeSpan) ? null : new CancellationTokenSource(timeout));
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public virtual async ValueTask<TValue> InvokeAsync<TValue>(string identifier,
